package lab7.advanced.dao;

import lab7.advanced.database.Database;
...
//pt un film dat prin moveId ia toti actorii asociati acelui film din tabela de legatura movie_actors
    ...
    public void update(int id, String title, int year, int duration, String soundtrack, int genreId) {

        try (Connection connection = Database.getConnection();
             PreparedStatement pstmt = connection.prepareStatement("UPDATE movies SET title = ?, year = ?, duration = ?, soundtrack = ?, genre_id = ? WHERE id = ?")) {
            ...
            System.err.println("eroare la update film: " + e.getMessage());
        }
    }
    ...
    public boolean updateScore(int id, double score) {
        ...
        try (Connection connection = Database.getConnection();
             PreparedStatement pstmt = connection.prepareStatement("UPDATE movies SET score = ? WHERE id = ?")) {
            ...
            System.err.println("eroare la modificare scor film: " + e.getMessage());
            return false;
        }
    }
    ...
    public boolean delete(int id) {
        ...
        try (Connection connection = Database.getConnection();
             PreparedStatement pstmt = connection.prepareStatement("DELETE FROM movies WHERE id = ?")) {
            ...
            System.err.println("eroare la stergere film: " + e.getMessage());
            return false;
        }
    }
