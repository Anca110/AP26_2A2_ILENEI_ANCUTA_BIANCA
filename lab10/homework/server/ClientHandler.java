...
import homework.model.Question;
...
public class ClientHandler implements Runnable {
    ...
    public void run() {
        try {
            ...
            out.println("Scor: " + player.getScore());
            out.println("Timp total: " + player.getTotalTime());

            Player winner = game.getWinner();

            if (winner != null){
                out.println("Castigatorul curent este: "+ winner.getName()+ " cu scorul "+ winner.getScore()+ " si timpul "+ winner.getTotalTime());
            }
